      ...
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex flex-col items-center space-y-2">
          ...
          <motion.h1
            ...
            className="from-foreground to-foreground/40 bg-gradient-to-b bg-clip-text text-4xl font-bold text-transparent sm:text-5xl"
          >
          ...
          >
            ...
            coding and cloud-based development.
          </motion.p>
        </div>
        ...
        >
          ...
          >
            <TabsList className="bg-transparent h-10">
              <TabsTrigger
                value="monthly"
                className="data-[state=active]:bg-background rounded-full transition-all duration-300 data-[state=active]:shadow-sm px-6"
              >
                Monthly
              </TabsTrigger>
              <TabsTrigger
        ...
        <div className="mt-8 grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
          {plans.map((plan, index) => (
            ...
            >
              <Card
                className={cn(
                  "bg-card/50 backdrop-blur-sm relative h-full w-full text-left transition-all duration-300 hover:shadow-lg",
                  plan.popular
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 right-0 left-0 mx-auto w-fit z-10">
